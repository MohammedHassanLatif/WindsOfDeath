...
var mapDeux;
var tilesetDeux;
var backgroundLayerDeux;
var backgroundLayer1Deux;
var wallLayerDeux;
var cameraMain;
...
class Level2 extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image("tilesDeux", "../assets/maps/FieldAssets.png");
        this.load.tilemapTiledJSON("mapDeux", "../assets/maps/FieldLevel2.json");
        ...
        this.load.audio("level2Music", "../assets/wodMusic/Unseen Horrors.mp3");
    ...
    create() {
        ...
        mapDeux = this.make.tilemap({ key: "mapDeux" });
        tilesetDeux = mapDeux.addTilesetImage("FieldAssetsTiles", "tilesDeux");
        backgroundLayerDeux = mapDeux.createStaticLayer('Floor', tilesetDeux, 0, 0);
        backgroundLayer1Deux = mapDeux.createStaticLayer('Decoration', tilesetDeux, 0, 0);
        wallLayerDeux = mapDeux.createStaticLayer('Colliders', tilesetDeux, 0, 0);

        wallLayerDeux.setCollisionByProperty({ collides: true});
        this.physics.add.collider(this.player1, wallLayerDeux);
        this.physics.add.collider(this.player2, wallLayerDeux);
        ...
        this.cameraMain.setBounds(0,0, backgroundLayerDeux.width, backgroundLayerDeux.height);
        ...
        //adding more zombies
        this.makeZombie(this, 650 , 500, "zombie1");
        this.makeZombie(this, 690 , 610, "zombie1");
        this.makeZombie(this, 780 , 540, "zombie1");
        this.makeZombie(this, 830 , 590, "zombie1");
        this.makeZombie(this, 890 , 520, "zombie1");
        this.makeZombie(this, 1030 , 330, "zombie1");

        this.makeZombie(this, 1100 , 240, "zombie1");
        this.makeZombie(this, 1200 , 260, "zombie1");
        this.makeZombie(this, 1280 , 280, "zombie1");
        this.makeZombie(this, 1370 , 250, "zombie1");
        this.makeZombie(this, 1480 , 240, "zombie1");
        this.makeZombie(this, 1550 , 270, "zombie1");

        this.makeZombie(this, 1640 , 280, "zombie1");
        this.makeZombie(this, 1690 , 270, "zombie1");
        this.makeZombie(this, 1780 , 300, "zombie1");
        this.makeZombie(this, 1910 , 380, "zombie1");
        this.makeZombie(this, 1990 , 350, "zombie1");
        this.makeZombie(this, 2150 , 360, "zombie1");

        this.makeZombie(this, 2290 , 410, "zombie1");
        this.makeZombie(this, 2390 , 400, "zombie1");
        this.makeZombie(this, 2430 , 420, "zombie1");
        this.makeZombie(this, 2500 , 390, "zombie1");
        ...
        this.physics.add.collider(this.zombies, wallLayerDeux);

        this.physics.add.collider(this.player1bullets, wallLayerDeux, function(p1bullet){
            if(p1bullet)
            {
                p1bullet.destroy();
            }
        ...
        this.physics.add.collider(this.player2bullets, wallLayerDeux, function(p2bullet){
            if(p2bullet)
            {
                p2bullet.destroy();
            }
        ...
        this.goal = new Goal(this, 2800, 360, "goal");
        this.goal.assignScene("Level3");
        ...
        level2music = this.sound.add("level2Music", {loop: true});
        level2music.play();
    }
        ...
        if (this.p1Alive){
            if (!this.player1.getData("isDead")) {
                ...
                */
                ...
                this.player1.x = Phaser.Math.Clamp(this.player1.x, 0, backgroundLayerDeux.width);
                this.player1.y = Phaser.Math.Clamp(this.player1.y, 0, backgroundLayerDeux.height);
            }
            else
            {
        ...
        if (this.p2Alive){
            if (!this.player2.getData("isDead")) {
                ...
                */
                ...
                this.player2.x = Phaser.Math.Clamp(this.player2.x, 0, backgroundLayerDeux.width);
                this.player2.y = Phaser.Math.Clamp(this.player2.y, 0, backgroundLayerDeux.height);
            }
            else
            {
